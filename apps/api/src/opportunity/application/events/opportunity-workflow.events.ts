import type { ActionTargetType, WorkflowDecisionStatus } from '@tfg/types';
...
export class OpportunityQualificationUpdatedEvent extends DomainEvent {
  readonly eventName = 'opportunity.qualification.updated';
  constructor(
    public readonly opportunityId: string,
    public readonly accountId: string,
