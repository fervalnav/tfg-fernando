...
La integración continua reproduce la instalación bloqueada de dependencias y
...
\begin{longtable}{@{}L{3.6cm}L{3.1cm}L{5.4cm}L{1.6cm}@{}}
  ...
  Solvencia no sustentada & RF-012; RF-016; RNF-008 & Banco ficticio, repeticiones y revisiones ciegas. & Parcial \\
  Error y recuperación de IA & RF-017; RN-010 & Persistencia de estado fallido y reintento de la acción. & Completo \\
\end{longtable}
