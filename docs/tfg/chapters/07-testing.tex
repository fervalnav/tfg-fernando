...
decisiones de workflow. Si el despliegue utiliza un único modelo global, se
selecciona Flash porque la ausencia de alucinaciones críticas prevalece sobre
la diferencia de coste. La campaña conserva la limitación de cuota y el tamaño
...
\begin{longtable}{@{}L{3.6cm}L{3.1cm}L{5.4cm}L{1.6cm}@{}}
  ...
  \bottomrule
  \endlastfoot
  Sesión inválida y acceso cruzado & RF-001--002; RN-001--002; RNF-001 & Servicio de sesión y E2E de autenticación y aislamiento. & Completo \\
  Escalada de privilegios & RF-003; RN-003; RNF-001 & Guarda unitaria y matriz E2E de roles y autoeliminación. & Completo \\
  ...
  Salida de IA con forma incorrecta & RF-011; RF-015; RN-008; RNF-005; RNF-007 & Esquemas, fake determinista y adaptador de Google. & Completo \\
  Documento no válido o inseguro & RF-013--014; RN-002; RN-009; RNF-001 & Handlers, API E2E y navegador E2E con acceso directo, firmado y caducado. & Completo \\
  Solvencia no sustentada & RF-012; RF-016; RNF-008 & Banco ficticio, repeticiones, revisiones ciegas y selección por operación. & Completo \\
  Error y recuperación de IA & RF-017; RN-007; RNF-003 & Persistencia de estado fallido, presentación del error y reintento de la acción. & Completo \\
\end{longtable}
