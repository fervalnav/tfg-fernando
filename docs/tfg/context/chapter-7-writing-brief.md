...
| Evaluación de solvencia incorrecta o no sustentada | RF-012, RF-016, RNF-008 | Banco ficticio, repeticiones, dos revisiones ciegas y selección por operación | Completo: Flash para resúmenes y Flash-Lite para las otras operaciones |
...
RF-012, RF-016, RI-008 y RNF-008 quedan alineados con el banco externo y la
