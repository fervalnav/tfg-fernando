# Análisis de las referencias para la iteración M2

Este documento compara cómo presentan la planificación y los costes las tres
memorias de `docs/refs`. El objetivo es adoptar una estructura académica
coherente y, por decisión del autor, reutilizar la tarifa laboral común a dos de
las referencias, manteniendo independientes el resto de cifras y decisiones.

## Patrones compartidos

Las tres memorias incluyen los siguientes elementos:

1. explicación de la metodología de trabajo;
2. descripción temporal de los sprints;
3. representación mediante un diagrama de Gantt;
4. tabla de horas estimadas por sprint;
5. comparación entre horas estimadas y reales;
6. presupuesto separado en costes directos e indirectos;
7. amortización del equipo utilizado;
8. total económico del proyecto.

Las memorias de Ignacio Blanquero y José Luis añaden reservas, beneficio e IVA,
tratando el presupuesto como una oferta comercial. La de Joaquín Arregui añade
además un coste real recalculado tras la desviación horaria.

## Diferencias relevantes para LIA
